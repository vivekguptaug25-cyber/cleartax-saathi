...
<main style="max-width:1100px;margin:0 auto;padding:140px 24px 80px;">
	<header style="margin-bottom:40px;">
		<h1 style="font-size:clamp(2.4rem,4vw,4rem);margin-bottom:12px;"><?php the_archive_title(); ?></h1>
		<?php the_archive_description( '<div style="color:#94A3B8;max-width:720px;">', '</div>' ); ?>
	</header>
	<?php if ( have_posts() ) : ?>
